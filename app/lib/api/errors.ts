...
export const ERROR_MESSAGES: Record<ErrorCode, string> = {
    ...
    INVALID_VIDEO_FORMAT: '動画ファイルを読み込めませんでした。対応形式（MP4, MOV, WebM）をご確認ください。',
    FILE_TOO_LARGE: 'ファイルサイズが大きすぎます。100MB以下の動画をアップロードしてください。',
    INVALID_PARAMETER: 'パラメータが不正です。設定を確認してください。',
    MODEL_INFERENCE_ERROR: '姿勢推定処理中にエラーが発生しました。しばらく時間をおいて再度お試しください。',
    STORAGE_SERVICE_UNAVAILABLE: 'サービスが一時的に利用できません。しばらく時間をおいて再度お試しください。',
    // Client errors
